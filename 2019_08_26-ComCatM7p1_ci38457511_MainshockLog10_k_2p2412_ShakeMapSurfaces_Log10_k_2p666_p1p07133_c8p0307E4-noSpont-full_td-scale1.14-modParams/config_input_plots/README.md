# ETAS Configuration for ComCat M7.1 (ci38457511), Mainshock Log10(k)=-2.2412, ShakeMap Surfaces, Log10(k)=-2.666, p=1.07133, c=8.0307E-4
...
| Config Generated With | u3etas_comcat_event_config_builder.sh --event-id ci38457511 --num-simulations 100000 --days-before 7 --etas-k -2.666 --etas-p 1.07133 --etas-c 8.0307E-4 --mainshock-etas-k -2.2412 --finite-surf-shakemap --finite-surf-shakemap-min-mag 5 --hpc-site USC_HPC --nodes 36 --hours 24 --queue scec_hiprio |
...
```
{
  ...
  "numRetries": 3,
  "outputDir": "${ETAS_SIM_DIR}/2019_08_26-ComCatM7p1_ci38457511_MainshockLog10_k_2p2412_ShakeMapSurfaces_Log10_k_2p666_p1p07133_c8p0307E4-noSpont-full_td-scale1.14-modParams",
  "triggerRuptures": [
    {
  ...
  "etas_c": 8.0307E-4,
  "etas_log10_k": -2.666,
  "configCommand": "u3etas_comcat_event_config_builder.sh --event-id ci38457511 --num-simulations 100000 --days-before 7 --etas-k -2.666 --etas-p 1.07133 --etas-c 8.0307E-4 --mainshock-etas-k -2.2412 --finite-surf-shakemap --finite-surf-shakemap-min-mag 5 --hpc-site USC_HPC --nodes 36 --hours 24 --queue scec_hiprio",
  "configTime": 1566867655389,
  "comcatMetadata": {
    "region": {
      "border": [
        {
