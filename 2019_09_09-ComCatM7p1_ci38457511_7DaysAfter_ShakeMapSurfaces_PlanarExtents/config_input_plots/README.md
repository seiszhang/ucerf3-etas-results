# ETAS Configuration for ComCat M7.1 (ci38457511), 7 Days After, ShakeMap Surfaces (Planar Extents)
...
| Ash Hill | 162, 90, 180 | 16 | 3.57 | 16 | 3.57 | 0.563 | 0.000 | 34.965 | 23.956 | 35.690 | 25.242 |
...
| Garlock (West) | 56, 90, 0 | 0 |  | 0 |  | 19.042 | 18.949 | 65.671 | 63.472 | 66.575 | 62.627 |
| Scodie Lineament | 221, 68, 0 | 0 |  | 0 |  | 20.820 | 19.945 | 28.750 | 27.691 | 36.559 | 32.668 |
| Towne Pass | 195, 50, -90 | 0 |  | 0 |  | 23.917 | 23.858 | 52.717 | 52.715 | 59.662 | 59.451 |
...
```
{
  ...
  "forceRecalc": false,
  "simulationName": "ComCat M7.1 (ci38457511), 7 Days After, ShakeMap Surfaces (Planar Extents)",
  "numRetries": 3,
  "outputDir": "${ETAS_SIM_DIR}/2019_09_09-ComCatM7p1_ci38457511_7DaysAfter_ShakeMapSurfaces_PlanarExtents",
  "triggerRuptures": [
    {
  ...
  "configCommand": "u3etas_comcat_event_config_builder.sh --event-id ci38457511 --num-simulations 100000 --days-before 7 --days-after 7 --mag-complete 3.5 --finite-surf-shakemap --finite-surf-shakemap-min-mag 5 --finite-surf-shakemap-planar-extents --hpc-site USC_HPC --nodes 36 --hours 24 --queue scec",
  "configTime": 1568075478572,
  "comcatMetadata": {
    "region": {
      "border": [
        {
