# ETAS Configuration for ComCat M7.1 (ci38457511), ShakeMap Surfaces, CulledSurface

|   | ComCat M7.1 (ci38457511), ShakeMap Surfaces, CulledSurface |
|-----|-----|
...
```
{
  ...
  "forceRecalc": false,
  "simulationName": "ComCat M7.1 (ci38457511), ShakeMap Surfaces, CulledSurface",
  "numRetries": 3,
