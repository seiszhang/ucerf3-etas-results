# ETAS Configuration for ComCat M7.1 (ci38457511), ShakeMap Surfaces, kCOV=1.16
...
```
{
  ...
  "numRetries": 3,
  "outputDir": "${ETAS_SIM_DIR}/2019_11_05-ComCatM7p1_ci38457511_ShakeMapSurfaces_kCOV1p16",
