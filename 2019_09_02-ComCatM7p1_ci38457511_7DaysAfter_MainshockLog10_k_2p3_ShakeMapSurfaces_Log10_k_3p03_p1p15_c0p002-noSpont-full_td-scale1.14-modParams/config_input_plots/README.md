...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| Airport Lake | 359, 50, -90 | 889 | 7.1 | 889 | 7.1 | 0.036 | 0.000 | 0.036 | 0.000 | 5.612 | 0.000 |
| Little Lake | 327, 90, 180 | 309 | 5.5 | 310 | 7.1 | 1.937 | 0.000 | 11.284 | 0.000 | 13.471 | 1.469 |
| Garlock (Central) | 71, 90, 0 | 108 | 4.73 | 109 | 7.1 | 0.225 | 0.000 | 5.600 | 0.000 | 22.766 | 10.797 |
| So Sierra Nevada | 2, 50, -90 | 63 | 4.52 | 63 | 4.52 | 1.134 | 0.000 | 4.248 | 4.233 | 16.191 | 15.188 |
...
```
{
  ...
  "numRetries": 3,
  "outputDir": "${ETAS_SIM_DIR}/2019_09_02-ComCatM7p1_ci38457511_7DaysAfter_MainshockLog10_k_2p3_ShakeMapSurfaces_Log10_k_3p03_p1p15_c0p002-noSpont-full_td-scale1.14-modParams",
  "triggerRuptures": [
    {
