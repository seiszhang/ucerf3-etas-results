# ETAS Configuration for ComCat M7.1 (ci38457511), 28 Days After, ShakeMap Surfaces, No Faults
...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| Airport Lake | 359, 50, -90 | 1021 | 7.1 | 1021 | 7.1 | 0.036 | 0.000 | 0.036 | 0.000 | 5.612 | 0.000 |
...
```
{
  ...
  "forceRecalc": false,
  "simulationName": "ComCat M7.1 (ci38457511), 28 Days After, ShakeMap Surfaces, No Faults",
  "numRetries": 3,
  "outputDir": "${ETAS_SIM_DIR}/2019_08_20-ComCatM7p1_ci38457511_28DaysAfter_ShakeMapSurfaces_NoFaults-noSpont-poisson-griddedOnly",
  "triggerRuptures": [
    {
  ...
  "configCommand": "u3etas_comcat_event_config_builder.sh --event-id ci38457511 --num-simulations 100000 --days-before 7 --days-after 28 --gridded-only --finite-surf-shakemap --finite-surf-shakemap-min-mag 5 --hpc-site USC_HPC --nodes 36 --hours 24 --queue scec",
  "configTime": 1566353804527,
  "comcatMetadata": {
    "region": {
      "border": [
        {
