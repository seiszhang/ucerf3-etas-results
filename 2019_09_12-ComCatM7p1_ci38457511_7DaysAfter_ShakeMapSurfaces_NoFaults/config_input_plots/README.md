# ETAS Configuration for ComCat M7.1 (ci38457511), 7 Days After, ShakeMap Surfaces, No Faults
...
| Garlock (West) | 56, 90, 0 | 0 |  | 0 |  | 19.042 | 18.949 | 63.115 | 60.529 | 66.575 | 62.627 |
| Scodie Lineament | 221, 68, 0 | 0 |  | 0 |  | 20.820 | 19.945 | 28.750 | 27.702 | 36.559 | 32.668 |
| Towne Pass | 195, 50, -90 | 0 |  | 0 |  | 23.917 | 23.858 | 52.561 | 52.559 | 59.662 | 59.451 |
...
```
{
  ...
  "forceRecalc": false,
  "simulationName": "ComCat M7.1 (ci38457511), 7 Days After, ShakeMap Surfaces, No Faults",
  "numRetries": 3,
  "outputDir": "${ETAS_SIM_DIR}/2019_09_12-ComCatM7p1_ci38457511_7DaysAfter_ShakeMapSurfaces_NoFaults",
  "triggerRuptures": [
    {
  ...
  "configCommand": "u3etas_comcat_event_config_builder.sh --event-id ci38457511 --num-simulations 100000 --days-before 7 --days-after 7 --gridded-only --mag-complete 3.5 --finite-surf-shakemap --finite-surf-shakemap-min-mag 5 --hpc-site USC_HPC --nodes 36 --hours 24 --queue scec",
  "configTime": 1568307009417,
  "comcatMetadata": {
    "region": {
      "border": [
        {
