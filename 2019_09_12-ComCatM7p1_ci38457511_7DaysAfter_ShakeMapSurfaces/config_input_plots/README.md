# ETAS Configuration for ComCat M7.1 (ci38457511), 7 Days After, ShakeMap Surfaces
...
```
{
  ...
  "numRetries": 3,
  "outputDir": "${ETAS_SIM_DIR}/2019_09_12-ComCatM7p1_ci38457511_7DaysAfter_ShakeMapSurfaces",
  "triggerRuptures": [
    {
  ...
  "configCommand": "u3etas_comcat_event_config_builder.sh --event-id ci38457511 --num-simulations 100000 --days-before 7 --days-after 7 --mag-complete 3.5 --finite-surf-shakemap --finite-surf-shakemap-min-mag 5 --hpc-site USC_HPC --nodes 36 --hours 24 --queue scec",
  "configTime": 1568306955793,
  "comcatMetadata": {
    "region": {
      "border": [
        {
