# ETAS Configuration for ComCat M7.1 (ci38457511), 28 Days After, ShakeMap Surfaces
...
```
{
  ...
  "numRetries": 3,
  "outputDir": "${ETAS_SIM_DIR}/2019_09_12-ComCatM7p1_ci38457511_28DaysAfter_ShakeMapSurfaces",
  "triggerRuptures": [
    {
    ...
    {
      "occurrenceTimeMillis": 1562388874790,
