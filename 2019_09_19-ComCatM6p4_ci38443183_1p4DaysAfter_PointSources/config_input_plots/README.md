# ETAS Configuration for ComCat M6.4 (ci38443183), 1.4 Days After, Point Sources
...
```
{
  ...
  "forceRecalc": false,
  "simulationName": "ComCat M6.4 (ci38443183), 1.4 Days After, Point Sources",
  "numRetries": 3,
  "outputDir": "${ETAS_SIM_DIR}/2019_09_19-ComCatM6p4_ci38443183_1p4DaysAfter_PointSources",
  "triggerRuptures": [
