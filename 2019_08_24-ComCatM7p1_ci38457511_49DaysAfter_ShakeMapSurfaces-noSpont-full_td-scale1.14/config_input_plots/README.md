# ETAS Configuration for ComCat M7.1 (ci38457511), 49 Days After, ShakeMap Surfaces
...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| Airport Lake | 359, 50, -90 | 1059 | 7.1 | 1059 | 7.1 | 0.036 | 0.000 | 0.036 | 0.000 | 5.612 | 0.000 |
| Little Lake | 327, 90, 180 | 338 | 5.5 | 339 | 7.1 | 1.937 | 0.000 | 11.284 | 0.000 | 13.471 | 1.469 |
| Garlock (Central) | 71, 90, 0 | 149 | 4.73 | 150 | 7.1 | 0.225 | 0.000 | 5.600 | 0.000 | 22.766 | 10.797 |
| So Sierra Nevada | 2, 50, -90 | 124 | 4.62 | 124 | 4.62 | 1.134 | 0.000 | 4.248 | 4.233 | 16.191 | 15.188 |
...
```
{
  ...
  "duration": 10.0,
  "startTimeMillis": 1566616794040,
  "includeSpontaneous": false,
  "randomSeed": 1566675437346,
  "binaryOutput": true,
  "binaryOutputFilters": [
    {
  ...
  "forceRecalc": false,
  "simulationName": "ComCat M7.1 (ci38457511), 49 Days After, ShakeMap Surfaces",
  "numRetries": 3,
  "outputDir": "${ETAS_SIM_DIR}/2019_08_24-ComCatM7p1_ci38457511_49DaysAfter_ShakeMapSurfaces-noSpont-full_td-scale1.14",
  "triggerRuptures": [
    {
    ...
    {
      "occurrenceTimeMillis": 1566538645880,
    ...
    {
      "occurrenceTimeMillis": 1566587982700,
      "comcatEventID": "ci39002264",
      "mag": 3.29,
      "latitude": 35.831665,
      "longitude": -117.6500015,
      "depth": 3.55
    },
    {
  ...
  "configCommand": "u3etas_comcat_event_config_builder.sh --event-id ci38457511 --num-simulations 100000 --days-before 7 --days-after 49 --finite-surf-shakemap --finite-surf-shakemap-min-mag 5 --hpc-site USC_HPC --nodes 36 --hours 24 --queue scec",
  "configTime": 1566675437346,
  "comcatMetadata": {
    "region": {
      "border": [
        {
